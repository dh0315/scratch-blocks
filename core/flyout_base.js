...
Blockly.Flyout.prototype.addMouseOverEvent = function () {
  ...
  var scrollbar = document.getElementsByClassName(
  ...
  if (flyoutElement && clipRectElement && path.length > 0) {
    ...
    flyoutElement.addEventListener("mouseover", function () {
      ...
      path[0].setAttribute(
        "d",
        "M 0,0 h 450 a 0 0 0 0 1 0 0 v 2000 a 0 0 0 0 1 0 0 h -450 z"
      );
    ...
    flyoutElement.addEventListener("mouseout", function () {
      ...
      path[0].setAttribute(
        "d",
        "M 0,0 h 250 a 0 0 0 0 1 0 0 v 2000 a 0 0 0 0 1 0 0 h -250 z"
      );
